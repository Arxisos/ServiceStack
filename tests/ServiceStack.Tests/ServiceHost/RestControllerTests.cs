...
namespace ServiceStack.Tests.ServiceHost
{
	...
	public class RestControllerTests
	{
		...
		{
			IRestController controller = new RestController();
			controller.RegisterRestPath(new RestPath(typeof(RequestDto), "/hello", "GET", null, null, null, true));
		...
		{
			IRestController controller = new RestController();
			controller.RegisterRestPath(new RestPath(typeof(RequestDto), "/hello", "GET, POST", null, null, null, true));
